import { heroBlock, projectsGridBlock, contactBlock, experienceBlock, certificationsBlock, skillsBlock } from "./blocks";
...
export const TEMPLATES = [
  {
    ...
    blocks: [heroBlock, skillsBlock, experienceBlock, projectsGridBlock, certificationsBlock, contactBlock],
  },
  {
    id: "modern",
    name: "Modern Minimal",
